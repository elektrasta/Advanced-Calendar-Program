...
{
    public partial class arastirmaciSifremiUnuttum : Form
    {
        public arastirmaciSifremiUnuttum()
        {
            InitializeComponent();
        }
        ...
        private void btnSifremiGoster_Click(object sender, EventArgs e)
        {
            ...
            {
                baglanti.Open();
                SqlCommand komut = new SqlCommand("select sifre from Arastirmaci where telefon='" + mskTelefon.Text + "' and kullaniciAdi='" + txtKullaniciAdi.Text + "'", baglanti);
