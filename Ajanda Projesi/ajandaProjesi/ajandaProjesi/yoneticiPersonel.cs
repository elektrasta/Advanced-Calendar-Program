...
namespace ajandaProjesi
{
    public partial class yoneticiPersonel : Form
    {
        ...
        private void yoneticiPersonel_Load(object sender, EventArgs e)
        {
            KayitGoster();
        }
        ...
        {
            baglanti.Open();
            SqlDataAdapter adtr = new SqlDataAdapter("SELECT ad,soyad,kullaniciAdi,telefon,meslek FROM Personel", baglanti);
