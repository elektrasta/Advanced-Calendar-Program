...
{
    public partial class personelSifremiUnuttum : Form
    {
        public personelSifremiUnuttum()
        {
            InitializeComponent();
        }
        ...
        private void btnSifremiGoster_Click(object sender, EventArgs e)
        {
            ...
            {
                baglanti.Open();
                SqlCommand komut = new SqlCommand("select sifre from Personel where telefon='" + mskTelefon.Text + "' and kullaniciAdi='" + txtKullaniciAdi.Text + "'", baglanti);
